...
public class PostResourcesTest {
    ...
    private final static Logger LOGGER = Logger.getLogger(PostResourcesTest.class.getName());
    ...
    public static WebArchive createDeployment() {
        ...
        WebArchive war = ShrinkWrap.create(WebArchive.class, "PostResourcesTest.war")
                ...
                .addPackage(PostResources.class.getPackage())
    ...
    @Test
    @RunAsClient
    public void testPostsEndpoints() throws Exception {
