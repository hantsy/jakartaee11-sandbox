...
class EmployeeCriteriaBuilderTest {
    private static final Logger log = LoggerFactory.getLogger(EmployeeCriteriaBuilderTest.class);
    ...
    void setUp() {
        ...
        var deletePersonQuery = builder.createCriteriaDelete(Employee.class);
